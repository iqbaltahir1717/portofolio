                                    ...
                                    <div class="modal fade" id="modalUpdate<?php echo $key->faq_id?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <?php echo form_open("admin/faq/update")?>
                                                <div class="modal-body">
                                                    <?php echo csrf();?>
                                                    <div class="form-group">
                                                        <label for=""><b style="color: black">Pertanyaan <span style="color:red">*</span></b></label>
                                    ...
                                    <div class="modal fade" id="modalDelete<?php echo $key->faq_id?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <?php echo form_open("admin/faq/delete")?>
                                                <div class="modal-body">
                                                    Apakah anda yakin akan menghapus data faq : "<?php echo $key->faq_question;?>" ?
                                                    <?php echo csrf();?>
                                                    <input type="hidden" class="form-control" placeholder="Pertanyaan" name="faq_question" required="required" value="<?php echo $key->faq_question;?>">
                                                    <input type="hidden" class="form-control" name="faq_id" required="required" value="<?php echo $key->faq_id;?>">
                                                </div>
                                                <div class="modal-footer">
