                    ...
                    <div class="box">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" style="width:100%" name="regulation_category_id" required>
                                                        <option value="">- Pilih Kategori -</option>
                                                        <?php
                                                            foreach($regulation_category as $rc){
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php 
                                    if($regulation){
                                        $nox = 1; $no=1; foreach($regulation as $key){
                                ...
                                ?>
                                    ...
                                    <!-- Modal Update-->
                                    <div class="modal fade" id="modalUpdate<?php echo $key->regulation_id?>" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" style="width:100%" name="regulation_category_id" required>
                                                            ...
                                                            <?php
                                                                foreach($regulation_category as $rc){
                                                                    if($key->regulation_category_id == $rc->regulation_category_id){
