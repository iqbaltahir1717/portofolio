                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- <div class="form-group">
                                        <label for=""><b style="color: black">Kategori Bidang <span style="color:red">*</span></b></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="link Informasi" name="link"  value="<?php echo $news[0]->link;?>">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Tanggal Pelaksanaan </b></label>
                                        <input type="datetime-local" class="form-control" placeholder="tgl Informasi" name="tanggal_jadwal"  value="<?php echo $news[0]->tanggal_jadwal;?>">
                                    </div>
