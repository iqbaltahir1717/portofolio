                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Url Informasi" name="link">
                                    </div>

                                    <div class="form-group">
                                        <label for=""><b style="color: black">Tanggal Pelaksanaan</b></label>
                                        <input type="datetime-local" class="form-control" placeholder="tgl Informasi" name="tanggal_jadwal">
                                    </div>
