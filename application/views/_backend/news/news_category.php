                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php 
                                    if($news_category){
                                        $nox = 1; $no=1; foreach($news_category as $key){
                                    ...
                                    <div class="modal fade" id="modalDelete<?php echo $key->news_category_id?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Apakah anda yakin akan menghapus data kategori informasi : <?php echo $key->news_category_name;?> ?
                                                    <?php echo csrf();?>
                                                    <input type="hidden" class="form-control" placeholder="Nama Kategori Informasi" name="news_category_name" required="required" value="<?php echo $key->news_category_name;?>">
                                                    <input type="hidden" class="form-control" name="news_category_id" required="required" value="<?php echo $key->news_category_id;?>">
                                                </div>
                                                <div class="modal-footer">
                                    ...
                                    <div class="modal fade" id="modalDetail<?php echo $key->news_category_id?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <b>Nama Kategori Informasi :</b><br><?php echo $key->news_category_name;?>
