                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for=""><b style="color: black">Judul Video <span style="color:red">*</span></b></label>
                                                    <input type="text" class="form-control" placeholder="Judul Video" name="gallery_name" required="required">
                                                ...
                                                <div class="form-group">
                                                    <label for=""><b style="color: black">Link Video (Youtube) <span style="color:red">(opsional)</span></b></label>
                                                    <input type="text" class="form-control" placeholder="Link Video" name="gallery_url">
                                                </div>
                                                <div class="form-group">
                                                    <label for=""><b style="color: black">File Video </b></label>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""><b style="color: black">Judul Video <span style="color:red">*</span></b></label>
                                                        <input type="text" class="form-control" placeholder="Judul Video" name="gallery_name" required="required" value="<?php echo $key->gallery_name;?>">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""><b style="color: black">Link Video (Youtube) <span style="color:red">(opsional)</span></b></label>
                                                        <input type="text" class="form-control" placeholder="Link Video" name="gallery_url" value="<?php echo $key->gallery_url;?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for=""><b style="color: black">File Video</b></label><br>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <?php echo csrf();?>
                                                    <input type="hidden" class="form-control" placeholder="Judul Video" name="gallery_name" required="required" value="<?php echo $key->gallery_name;?>">
                                                    <input type="hidden" class="form-control" name="gallery_id" required="required" value="<?php echo $key->gallery_id;?>">
                                    ...
                                    <div class="modal fade" id="modalDetail<?php echo $key->gallery_id?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <b>Judul Video :</b><br><?php echo $key->gallery_name;?><br><br>
