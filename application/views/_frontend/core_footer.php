                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4 class="color-1">Link Terkait</h4>
                            <ul>
                        ...
                        <div class="col-lg-4 col-md-6 footer-links">
                            <h4 class="color-1">Kontak Kami</h4>
                            <ul>
                                <li><i class="bx bx-chevron-right" style="color:#fff"></i>
                                <a href=""><?php echo $setting[0]->setting_phone;?></li></a>
                                <li>
                                <i class="bx bx-chevron-right" style="color:#fff"></i>
                                <a href=""><?php echo $setting[0]->setting_email;?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
