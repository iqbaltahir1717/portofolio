                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="sidebar-item search-form">
                            <?php echo form_open("page/tracking_search/".$this->uri->segment(3), "style='display:flex;align-items: center;'")?>
                                <input type="text" class="form-control mr-2" style="width:50%" placeholder="Masukkan Kode Tracking" name="key" >
                                <a class ="btn btn-model-3" type="submit" >Cek</a>
                            <?php echo form_close();?>
                        </div>
                        <br>
